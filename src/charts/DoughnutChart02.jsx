  ...
  return (
    <div className="grow flex flex-col justify-center">
      ...
      <div className="pb-4 flex flex-col justify-center items-center">
        <p>Today's Usage Cost</p>
        <p className="text-3xl font-bold text-gray-800 dark:text-gray-100">$2.53</p>
        <div className='flex flex-row'>
          <div className="animate-pulse relative top-1.5 mr-1 w-2.5 h-2.5 bg-green-500 border-2 border-gray-100 dark:border-gray-900 rounded-full"></div>
          <p className="font-semibold text-gray-800 dark:text-gray-100">Live Monitoring</p>
        </div>
      </div>
    </div>
  );
