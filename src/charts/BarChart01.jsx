...
// Import utilities
import { tailwindConfig, formatValue, formatValueWatts } from '../utils/Utils';
			...
			options: {
				...
				scales: {
					y: {
						...
						ticks: {
							maxTicksLimit: 5,
							callback: (value) => formatValueWatts(value),
				...
				plugins: {
					...
					tooltip: {
						callbacks: {
							...
							label: (context) => formatValueWatts(context.parsed.y),
						},
