...
function DropdownNotifications({ align }) {
	...
	return (
		<div className="relative inline-flex">
			<Tooltip content="Notifications" placement="top" className="text-indigo-400 text-sm">
				<button
					ref={trigger}
						...
						<li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
							...
							>
								<span className="block text-sm mb-2">
									...
									or devices for any anomalies.
								</span>
								<span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Nov 30, 2024</span>
							</Link>
						</li>
						<li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
							<Link
							...
							>
								...
								<span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Nov 27, 2024</span>
							</Link>
						</li>
						<li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
							<Link
