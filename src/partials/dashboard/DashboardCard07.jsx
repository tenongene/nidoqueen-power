	...
	return (
		<div className="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
			<header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
				<h2 className="font-semibold text-gray-800 dark:text-gray-100">Top Power Consumption By Appliance</h2>
			</header>
			<div className="p-3">
				{/* Table */}
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Furnace</div>
									</div>
								</td>
								<td className="p-2">
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Air Conditioner</div>
									</div>
								</td>
								<td className="p-2">
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Water Heater</div>
									</div>
								</td>
								<td className="p-2">
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Dryer</div>
									</div>
								</td>
								<td className="p-2">
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Washer</div>
									</div>
								</td>
								<td className="p-2">
							...
							<tr>
								<td className="p-2">
									<div className="flex items-center">
										...
										<div className="text-gray-800 dark:text-gray-100">Refrigerator</div>
									</div>
								</td>
								<td className="p-2">
