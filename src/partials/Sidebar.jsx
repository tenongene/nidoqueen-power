											...
											>
												<div className="flex items-center justify-between">
													<div className="flex items-center">
														{/* <svg
															className={`shrink-0 fill-current ${
																pathname.includes('community') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
															}`}
															xmlns="http://www.w3.org/2000/svg"
															width="16"
															height="16"
											...
											>
												<div className="flex items-center justify-between">
													<div className="flex items-center">
														{/* <svg
															className={`shrink-0 fill-current ${
																pathname.includes('job') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
															}`}
															xmlns="http://www.w3.org/2000/svg"
															width="16"
															height="16"
											...
											>
												<div className="flex items-center justify-between">
													<div className="flex items-center">
														{/* <svg
															className={`shrink-0 fill-current ${
																pathname.includes('tasks') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
															}`}
															xmlns="http://www.w3.org/2000/svg"
															width="16"
															height="16"
								...
								>
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											{/* <svg
												className={`shrink-0 fill-current ${
													pathname.includes('messages') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
												}`}
												xmlns="http://www.w3.org/2000/svg"
												width="16"
												height="16"
											...
											>
												<div className="flex items-center justify-between">
													<div className="flex items-center">
														{/* <svg
															className={`shrink-0 fill-current ${
																pathname.includes('utility') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
															}`}
															xmlns="http://www.w3.org/2000/svg"
															width="16"
															height="16"
